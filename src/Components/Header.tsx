...
function Header(){
  ...
  return (
    <Nav variants={navVar} initial="top" animate={navAnimation} >
      <Col>
      <Logo variants={logoVariants} viewBox="0 0 1024 276.742" initial="normal" whileHover="active" exit="exit" width="1024" height="276.742" xmlns="http://www.w3.org/2000/svg">
